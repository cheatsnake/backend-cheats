...
-   ### Бенчмарки
    ...
    [Бенчмарк](https://ru.wikipedia.org/wiki/%D0%A2%D0%B5%D1%81%D1%82_%D0%BF%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D0%B8%D1%82%D0%B5%D0%BB%D1%8C%D0%BD%D0%BE%D1%81%D1%82%D0%B8) (в программном обеспечении) – это инструмент для измерения времени выполнения кода программы. Как правило измерение производится путем множественного запуска одного и того же кода (или определенной его части), где затем выполняется подсчет среднего времени, а также может предоставляется информацию о количестве произведенных операций и объеме выделяемой памяти.
