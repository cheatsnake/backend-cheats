...
-   ### Устройство веб-приложений
    ...
    -   создание функционала для формирования запросов к серверу (различные формы ввода)
    -   примем данных от сервера и их последующая обработка для вывода на клиент

    Задачи серверной части:
    -   обработка клиентских запросов (валидации, проверки доступа)
    -   выполнение бизнес логики (работа с базами данных, обработка информации, вычисления и т.д.) 
