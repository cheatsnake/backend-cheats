...
-   [Kotlin](https://ru.wikipedia.org/wiki/Kotlin)
    > Этакая современная версия [Java](https://ru.wikipedia.org/wiki/Java). Более простой и локаничный синтаксис, лучшая типобезопасность, наличие встроенных инструментов для многопоточности. Один из лучших выборов для разработки под Android.
