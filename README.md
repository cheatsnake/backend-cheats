...
-   ### VPN и Proxy
    ...
    -   [VPN (Virtual Private Network)](https://ru.wikipedia.org/wiki/VPN)
        > Технолгия позволяющая стать участником приватной сети (подобной вашей локальной), где запросы всех участников проходят через единый публичный IP-адресс. Это позволяет Вам смешаться в общей массе запросов от других участников.<br>
        `Плюсы`: <br>
        ...
        `Минусы`: <br>
        - Нет гарантирии 100% анонимности, поскольку владелец сети знает IP-адресса всех участников. <br>
        ...
        - Беспланые VPN, как правило, имеют большую нагруженность, что приводит к нестабильной работе и снижению скорости загрузки данных. <br>
    -   [Proxy (прокси-сервер)](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%BA%D1%81%D0%B8-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80)
        ...
        `Плюсы`: <br>
        - Возможность использовать индивидуальный IP-адресс, что позволяет рабоать с мультиаккаунтами. <br>
