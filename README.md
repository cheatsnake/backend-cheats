...
-   ### TCP/IP stack
    ...
    1. [Link layer](https://en.wikipedia.org/wiki/Link_layer)
    ...
    2. [Internet Layer](https://en.wikipedia.org/wiki/Internet_layer)
    ...
    3. [Transport Layer](https://en.wikipedia.org/wiki/Transport_layer)
    ...
    4. [Application Layer](https://en.wikipedia.org/wiki/Application_layer)
