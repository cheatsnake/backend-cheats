...
> Необходимо уметь работать с терминалом. Это предоставляет вам доступ ко всем возможностям ОС, в отличии от графического интерфейса, функционал которого существенного ограничен.

```bash
### РАБОТА С ФАЙЛОВОЙ СИСТЕМОЙ

ls # просмотр содержимого директории
ll # просмотр содержимого директории в формате таблицы
