...
-   ### Скрипты Bash
    ...
    -   Дополнительные ресурсы
        > В таких репозиториях как [awesome bash](https://github.com/awesome-lists/awesome-bash) и [awesome shell](https://github.com/alebcay/awesome-shell) собраны целые коллекции полезных штуковин, которые помогут ещё больше развить навыки работы с терминалом.
