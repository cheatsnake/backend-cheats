...
-   [1. Сеть и интернет](#сеть-и-интернет)
    ...
    -   [Хостинг](#хостинг)
    -   [Cтек протоколов TCP/IP](#cтек-протоколов-tcp/ip)
    -   [UDP протокол](#udp-протокол)
...
<p align="center">
    <img src="./files/tcp-ip.png" alt="TCP/IP"/>
</p>
...
<p align="center">
    <img src="./files/tcp.png" alt="TCP"/>
</p>

`TCP` - это протокол обеспечивающий надежную передачу данных. TCP гарантирует доставку данных и сохранение порядка следования сообщений. Но это сказывается на скорости передачи данных. Данный протокол используется там, где потеря информации недопустима, например для отправки почты.

<p align="center">
    <img src="./files/udp.png" alt="UDP"/>
</p>
