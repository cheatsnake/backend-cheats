...
-   ### Структуры данных
    ...
    -   [Хеш-таблица](https://ru.wikipedia.org/wiki/%D0%A5%D0%B5%D1%88-%D1%82%D0%B0%D0%B1%D0%BB%D0%B8%D1%86%D0%B0)
        > По другому ассоциативный массив. Здесь для обращения к каждому из элементов используются соответсвующее ключевое значение, которое вычисляется по определенному алгоритму.
