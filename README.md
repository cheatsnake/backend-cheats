...
-   ### Сетевая модель OSI
    ...
    -   Сетевой уровень
        > Происходит маршрутизация трафика, заросы к DNS и формирование IP-пакетов.
    ...
    -   Прикладной уровень
        > Уровень работы с приложениями. Здесь напрямую происходит взаимодействие с данными пользователя.
