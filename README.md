...
-   ### IPv4 и IPv6
    ...
    -   Преимущества IPv6
        > Имеет меньший размер таблицы марштуризации.
        > Упрощенный формат заголовка.
        > Встроенная поддержка технологии [Quality of Service (QoS)](https://ru.wikipedia.org/wiki/QoS).
        > Встроены аутентификация и частная поддержка.
